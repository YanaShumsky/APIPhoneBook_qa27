...
public class OkHttpLoginTest {
    ...
    @Test
    public void loginTestPositeve() throws IOException {
        Gson gson = new Gson();
        OkHttpClient client = new OkHttpClient();
    ...
    @Test
    public void loginTestNegativ() throws IOException {
        Gson gson = new Gson();
        OkHttpClient client = new OkHttpClient();

        AuthRequestDto requestDto = AuthRequestDto.builder()
                .email("john9090@mail.com")
                .password("Aa1234").build();
    ...
    @Test
    public void loginTestPositive1() throws IOException {
        Gson gson = new Gson();
        OkHttpClient client = new OkHttpClient();
